...
function HowItWorks () {
  return (
    <>
      <div className="flex flex-col items-center h-screen bg-krem">
        <div>
        ...
        <div className="flex justify-center items-center gap-20 mb-6 pb-10">
          <div className="relative w-96 h-64 bg-white rounded-xl shadow-lg p-6 flex items-center">
            <div className="absolute left-0 top-1/2 transform -translate-y-1/2 -ml-12 w-24 h-24 bg-[#F4D35E] rounded-full flex justify-center items-center">
              <span className="text-black text-2xl drop-shadow-lg font-semibold">1</span>
            </div>
            <div className="ml-24 flex flex-col justify-center h-full">
          ...
          <div className="relative w-96 h-64 bg-white rounded-xl shadow-lg p-6 flex items-center">
            <div className="absolute left-0 top-1/2 transform -translate-y-1/2 -ml-12 w-24 h-24 bg-[#F4D35E] rounded-full flex justify-center items-center">
              <span className="text-black text-2xl drop-shadow-lg font-semibold">2</span>
            </div>
            <div className="ml-24 flex flex-col justify-center h-full">
              <h1 className="py-1 text-4xl font-bold text-black drop-shadow-lg my-1">
                Login
        ...
        <div className="flex justify-center items-center gap-20">
          <div className="relative w-96 h-64 bg-white rounded-xl shadow-lg p-6 flex items-center">
            <div className="absolute left-0 top-1/2 transform -translate-y-1/2 -ml-12 w-24 h-24 bg-[#F4D35E] rounded-full flex justify-center items-center">
              <span className="text-black text-2xl drop-shadow-lg font-semibold">3</span>
            </div>
            <div className="ml-24 flex flex-col justify-center h-full">
              <h1 className="py-1 text-4xl font-bold text-black drop-shadow-lg my-1">
                Konsultasi
          ...
          <div className="relative w-96 h-64 bg-white rounded-xl shadow-lg p-6 flex items-center">
            <div className="absolute left-0 top-1/2 transform -translate-y-1/2 -ml-12 w-24 h-24 bg-[#F4D35E] rounded-full flex justify-center items-center">
              <span className="text-black text-2xl drop-shadow-lg font-semibold">4</span>
            </div>
            <div className="ml-24 flex flex-col justify-center h-full">
              <h1 className="py-1 text-4xl font-bold text-black drop-shadow-lg my-1">
                Solusi

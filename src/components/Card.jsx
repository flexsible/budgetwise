...
export default function Card () {
  return (
    ...
    <div className='flex mx-auto justify-center items-center'>
      <div className="flex flex-col rounded-2xl w-80 bg-[#ffffff] shadow-xl p-3 gap-6 mx-4">
        <figure className="flex justify-center items-center rounded-2xl">
            <img src="https://placehold.co/600x600" alt="Card Preview" className="rounded-2xl "/>
        </figure>
